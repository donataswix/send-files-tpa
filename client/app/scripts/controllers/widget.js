...
angular.module('sendFiles')
  .controller('WidgetCtrl', function ($scope, api, $wix) {
    ...
    /* These variables represent the default text in the widget.
     * They can be configured by the user, but these are their variable
     * names used in the widget's HTML file. */
